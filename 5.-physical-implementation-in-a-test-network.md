...
Each of these acitivities is realized by a function of the Smart Contract. The Smart Contract has its own ether wallet to store the total prepaid value of all actors.
