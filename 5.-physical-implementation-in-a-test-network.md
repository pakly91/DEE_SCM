...
2. "Chp" provides each kw/h for 3 Ether.
3. "Load" buys 10 kw/h from "Chp" for 30 Ether.



1. **"Load" charges its prepaid account with 40 Ether.**

To charge the prepaid account, "Load" executes the PayMe function of the SmartContract with the chosen amount of Ether.

![Choose function and amount of ether](.gitbook/assets/image%20%284%29.png)

![Send Ether from &quot;Load&quot; wallet to contract wallet](.gitbook/assets/image%20%288%29.png)

![Wallet of the contract \(top right\) and prepaid balance of &quot;load&quot;](.gitbook/assets/image%20%2813%29.png)
